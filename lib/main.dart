  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          var getAll = Usermodeloperation.mainInstance.getAlluser();
          for (var i in getAll) {
            print("The all user name is ${i.name}");
          }
          // setState(() {
          //   Usermodeloperation.mainInstance.deleteUser(context, "Shamlala");
          // });
          //  var adduser =  Usermodeloperation.mainInstance.createUser(Usermodel(age: 25.toString(), name: "Omkar Parab"));
          var getUser = Usermodeloperation.mainInstance.getSingleUserByName(
            "Shan",
          );
          print("the addUser is ==>>> ${getUser?.name}");
          // if (getUser != null) {
          //   Usermodeloperation.mainInstance.updateUser(getUser, "Shanatnu");
          // } else {
